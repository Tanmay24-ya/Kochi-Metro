...
const prefixToDept = (id)=>{
    const u = id.toUpperCase();
    if (u.startsWith('ADMIN')) return {
        slug: 'admin',
        label: 'Admin'
    };
    if (u.startsWith('OPS')) return {
        slug: 'operations',
        label: 'Operations'
    };
    if (u.startsWith('ENG')) return {
        slug: 'engineering',
        label: 'Engineering'
    };
    if (u.startsWith('MNT')) return {
        slug: 'maintenance',
        label: 'Maintenance'
    };
    if (u.startsWith('FIN')) return {
        slug: 'finance',
        label: 'Finance'
    };
    if (u.startsWith('HR')) return {
        slug: 'hr',
        label: 'HR'
    };
    return {
...
const LoginContent = ()=>{
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const urlToFetch = "".concat(API_BASE, "/documents/").concat(encodeURIComponent(department), "?skip=").concat(skip, "&limit=").concat(limit);
            // ADD THIS LINE
            console.log("Attempting to fetch from URL:", urlToFetch);
            // let response = await fetch(urlToFetch, { method: 'GET' });
            const response = await fetch(urlToFetch);
            if (!response.ok) {
                setError("Failed to fetch documents for department: ".concat(department));
                return;
            }
            ...
            if (isAdmin) {
                ...
                router.push("/dashboard?dept=".concat(departmentInfo.slug));
            }
        } catch (err) {
    ...
    const siteKey = ("TURBOPACK compile-time value", "6LdukdErAAAAAMPoTBywrVK-SHYAzmwflvpar4xW");
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center justify-center min-h-screen bg-gray-900",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-md p-8 space-y-8 bg-gray-950 rounded-2xl shadow-2xl",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "mt-4 text-2xl font-bold text-gray-300 capitalize",
                            children: [
                                role,
                                " Portal Access"
                            ]
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                    ...
                                    children: "User ID (e.g., FIN001, ENG002, ADMIN001)"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/app/login/page.tsx",
                                    lineNumber: 128,
                                    columnNumber: 25
...
_s(LoginContent, "p+a04e7fGvxSJlTm6nuXiCeGrkk=", false, function() {
    return [
