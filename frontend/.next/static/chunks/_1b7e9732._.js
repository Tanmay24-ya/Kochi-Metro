...
const fetchDashboardData = async ()=>{
    ...
    const mockData = {
        ...
        documents: [
            ...
            {
                id: 5,
                title: 'Maintenance Job Card #MJC-7891',
                type: 'Maintenance',
                date: '2025-09-18',
                status: 'deadline',
                department: 'Engineering'
    ...
    const filteredDocuments = mockData.documents.filter((doc)=>mockData.user.role === 'admin' || doc.department === 'all' || doc.department === mockData.user.department);
    return {
        user: mockData.user,
...
function DashboardPage() {
    ...
    }["DashboardPage.useEffect"], []); // The empty array [] means this effect runs only once after the component mounts.
...
_s(DashboardPage, "0ElksLb1iccqTpzdRp5w9n7S3Qs=");
_c2 = DashboardPage;
var _c, _c1, _c2;
...
//# sourceMappingURL=_1b7e9732._.js.map